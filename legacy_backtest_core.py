# mypy: ignore-errors
# Frozen 2026-09-15 technical backtest; source 027f459fdea2a79d04c77979f74c0b936cdbe370.
# Only imports are redirected to frozen dependencies. Do not change this model in place.
import logging
from typing import Any, Dict, List, Optional, Tuple

import numpy as np
import pandas as pd
import legacy_backtest_patterns as advanced_patterns
...
def is_strategy_signal(
    ...
    if df_slice is None or len(df_slice) < 21:
        return False, 0, {}
    from legacy_backtest_scoring import get_decision_score
