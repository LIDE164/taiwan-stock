# 最後修改時間: 2026-06-28 20:20 CST
# 版本: 原版完美 UI 保留 + Fugle/Yahoo API 核心升級 + 來源標示
...
# ==========================================
# 🟢 API 切換核心 2: 替換爬蟲為 Yahoo Finance
# ==========================================
@st.cache_data(ttl=86400, show_spinner=False)
