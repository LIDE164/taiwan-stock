...
def draw_professional_chart(df, latest_price, view_days, is_light_mode, show_buy_signal=False, show_sup_res=False, show_signals=True, buy_dates=[]):
    ...
    fig.update_xaxes(type='category', nticks=15, showgrid=True, gridcolor=grid_c, fixedrange=True)
    ...
    fig.update_layout(
        ...
        hovermode="x unified", dragmode=False, showlegend=False, hoverlabel=dict(font_size=12)
    )
    return fig